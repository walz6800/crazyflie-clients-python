...
connected Aeroflie. It is a read-only reference for what can be logged —
...
1.  Fields
    ...
    -   *ID:* Numerical identifier of the variable on the Aeroflie
    -   *Unpack:* Python type used to unpack the received data
    -   *Storage:* C type used to store the value on the Aeroflie
...
The tab is populated automatically when a Aeroflie connects and cleared when it disconnects.
